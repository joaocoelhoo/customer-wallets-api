...
module.exports = app => {
  const customerWalletsDB = app.data.customerWallets; // importação com consign
  // require('../data/customerWallets.json'); - importação sem consign
  const controller = {};

  const { customerWallets: customerWalletsMock,
  } = customerWalletsDB;
